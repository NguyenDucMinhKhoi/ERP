...
urlpatterns = [
    ...
    path('api/', include('app.apps.hocviens.urls')),
    ...
    path('api/', include('app.apps.lichhocs.urls')),
    path('api/', include('app.apps.diemdanhs.urls')),
    path('api/', include('app.apps.lophocs.urls')),
    path('api/', include('app.apps.teachers.urls')),
